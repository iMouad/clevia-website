...
export default function RevenueCalculator() {
  ...
  const commission = bruts * 0.2
  const nets = bruts * 0.8
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 border border-brun/10 flex flex-col gap-3">
              <div className="flex justify-between items-center text-sm">
                <span className="text-brun-mid" style={{ fontFamily: 'var(--font-dm-sans)' }}>{t('brutsLabel')}</span>
                <span className="text-brun font-medium tabular-nums" style={{ fontFamily: 'var(--font-dm-sans)' }}>{fmt(bruts)} MAD</span>
              </div>
              <div className="flex justify-between items-center text-sm">
                <span className="text-brun-mid" style={{ fontFamily: 'var(--font-dm-sans)' }}>{t('commissionLabel')} (20%)</span>
                <span className="text-brun-mid/60 tabular-nums" style={{ fontFamily: 'var(--font-dm-sans)' }}>−{fmt(commission)} MAD</span>
              </div>
              <div className="flex justify-between items-center pt-3 border-t border-brun/8">
                <span className="text-brun font-medium text-sm" style={{ fontFamily: 'var(--font-dm-sans)' }}>{t('netsLabel')}</span>
                <span className="text-terra font-medium tabular-nums" style={{ fontFamily: 'var(--font-cormorant)', fontSize: '1.2rem' }}>{fmt(nets)} MAD</span>
              </div>
            </div>
